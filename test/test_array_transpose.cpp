...
bool verify_blkwise_transpose(const T *src, T *dst, T *r, size_t bdim, size_t m, size_t n, T *cache)
{
	...
	return mem<T>::equal(ne, dst, r);
}


template<typename T>
bool verify_array2d_transpose(const caview2d<T>& a)
{
	index_t m = a.nrows();
...
TEST( ArrayTranspose, DirectTranspose )
{
	...
	EXPECT_TRUE( mem<double>::equal(m0 * n0, t0, r0) );
	...
	EXPECT_TRUE( mem<double>::equal(m1 * n1, t1, r1) );
	...
	EXPECT_TRUE( mem<double>::equal(m2 * n2, t2, r2) );
	...
	EXPECT_TRUE( mem<double>::equal(m3 * n3, t3, r3) );
	...
	EXPECT_TRUE( mem<double>::equal(m4 * n4, t4, r4) );
}
...
TEST( ArrayTranspose, DirectTransposeSquare )
{
	...
	EXPECT_TRUE( mem<double>::equal(1, t1, r1) );
	...
	EXPECT_TRUE( mem<double>::equal(4, t2, r2) );
	...
	EXPECT_TRUE( mem<double>::equal(9, t3, r3) );
	...
	EXPECT_TRUE( mem<double>::equal(16, t4, r4) );
}
...
TEST( ArrayTranspose, Array2DTranspose )
{
	const size_t Nmax = 40000;

	block<double> buf(Nmax);
	for (size_t i = 0; i < Nmax; ++i) buf[(index_t)i] = (double)(i + 1);
	...
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[0], ds[0]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[0], ds[1]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[0], ds[2]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[0], ds[3]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[0], ds[4]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[0], ds[5]) ) );

	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[1], ds[0]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[1], ds[1]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[1], ds[2]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[1], ds[3]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[1], ds[4]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[1], ds[5]) ) );

	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[2], ds[0]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[2], ds[1]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[2], ds[2]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[2], ds[3]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[2], ds[4]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[2], ds[5]) ) );

	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[3], ds[0]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[3], ds[1]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[3], ds[2]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[3], ds[3]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[3], ds[4]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[3], ds[5]) ) );

	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[4], ds[0]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[4], ds[1]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[4], ds[2]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[4], ds[3]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[4], ds[4]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[4], ds[5]) ) );

	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[5], ds[0]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[5], ds[1]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[5], ds[2]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[5], ds[3]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[5], ds[4]) ) );
	EXPECT_TRUE( verify_array2d_transpose( make_caview2d(src, ds[5], ds[5]) ) );
