...
template<class Derived>
bool dense_array_integrity_test(const bcs::dense_caview2d_base<Derived>& a)
{
...
template<class Derived>
bool elemwise_operation_test(bcs::aview2d_base<Derived>& a)
{
...
TEST( Array2D, Aview2DExRowMajor )
{
	...
	aview2d_ex<double, row_major_t, id_ind, id_ind> a0(src, 5, 6, id_ind(2), id_ind(3));
	...
	aview2d_ex<double, row_major_t, id_ind, step_ind> a1(src, 5, 6, id_ind(2), step_ind(3, 2));
	...
	aview2d_ex<double, row_major_t, step_ind, step_ind> a2(src, 5, 6, step_ind(2, 2), step_ind(3, 2));
	...
	aview2d_ex<double, row_major_t, step_ind, rep_ind> a3(src, 5, 6, step_ind(2, 2), rep_ind(3));
	...
	aview2d_ex<double, row_major_t, rep_ind, rep_ind> a4(src, 5, 6, rep_ind(2), rep_ind(3));
...
TEST( Array2D, Aview2DExColumnMajor )
{
	...
	aview2d_ex<double, column_major_t, id_ind, id_ind> a0(src, 5, 6, id_ind(2), id_ind(3));
	...
	aview2d_ex<double, column_major_t, id_ind, step_ind> a1(src, 5, 6, id_ind(2), step_ind(3, 2));
	...
	aview2d_ex<double, column_major_t, step_ind, step_ind> a2(src, 5, 6, step_ind(2, 2), step_ind(3, 2));
	...
	aview2d_ex<double, column_major_t, step_ind, rep_ind> a3(src, 5, 6, step_ind(2, 2), rep_ind(3));
	...
	aview2d_ex<double, column_major_t, rep_ind, rep_ind> a4(src, 5, 6, rep_ind(2), rep_ind(3));
	double r4[] = {1, 1, 1, 1, 1, 1};
...
BCS_TEST_CASE( test_array2d_slices )
{
	...
	ASSERT_TRUE( array_view_equal( Arm.row(1), r0_rm, 6 ) );
	ASSERT_TRUE( array_view_equal( Acm.row(1), r0_cm, 6 ) );
	...
	ASSERT_TRUE( array_view_equal( Arm.row(1, rgn_n(1, 4)), r1_rm, 4 ) );
	ASSERT_TRUE( array_view_equal( Acm.row(1, rgn_n(1, 4)), r1_cm, 4 ) );

	double r2_rm[3] = {9, 11, 13};
	double r2_cm[3] = {2, 16, 30};

	ASSERT_TRUE( array_view_equal( Arm.row(1, rgn_n(0, 3, 2)), r2_rm, 3 ) );
	ASSERT_TRUE( array_view_equal( Acm.row(1, rgn_n(0, 3, 2)), r2_cm, 3 ) );

	double r3_rm[3] = {11, 11, 11};
	double r3_cm[3] = {16, 16, 16};

	ASSERT_TRUE( array_view_equal( Arm.row(1, rep(2, 3)), r3_rm, 3 ) );
	ASSERT_TRUE( array_view_equal( Acm.row(1, rep(2, 3)), r3_cm, 3 ) );
	...
	ASSERT_TRUE( array_view_equal( Arm.column(1), c0_rm, 5 ) );
	ASSERT_TRUE( array_view_equal( Acm.column(1), c0_cm, 5 ) );
	...
	ASSERT_TRUE( array_view_equal( Arm.column(1, rgn_n(1, 4)), c1_rm, 4 ) );
	ASSERT_TRUE( array_view_equal( Acm.column(1, rgn_n(1, 4)), c1_cm, 4 ) );

	double c2_rm[3] = {2, 18, 34};
	double c2_cm[3] = {8, 10, 12};

	ASSERT_TRUE( array_view_equal( Arm.column(1, rgn_n(0, 3, 2)), c2_rm, 3 ) );
	ASSERT_TRUE( array_view_equal( Acm.column(1, rgn_n(0, 3, 2)), c2_cm, 3 ) );

	double c3_rm[3] = {18, 18, 18};
	double c3_cm[3] = {10, 10, 10};

	ASSERT_TRUE( array_view_equal( Arm.column(1, rep(2, 3)), c3_rm, 3 ) );
	ASSERT_TRUE( array_view_equal( Acm.column(1, rep(2, 3)), c3_cm, 3 ) );
...
BCS_TEST_CASE( test_array2d_subviews )
{
	...
	ASSERT_EQ( a0_rm.V(whole(), whole()),  get_aview2d_rm(a0_rm_s0, 5, 6) );
	ASSERT_EQ( a0_cm.V(whole(), whole()),  get_aview2d_cm(a0_cm_s0, 5, 6) );
	...
	ASSERT_EQ( a0_rm.V(rgn(0, 3), whole()),  get_aview2d_rm(a0_rm_s1, 3, 6) );
	ASSERT_EQ( a0_cm.V(rgn(0, 3), whole()),  get_aview2d_cm(a0_cm_s1, 3, 6) );
	...
	ASSERT_EQ( a0_rm.V(whole(), rgn(1, 4)),  get_aview2d_rm(a0_rm_s2, 5, 3) );
	ASSERT_EQ( a0_cm.V(whole(), rgn(1, 4)),  get_aview2d_cm(a0_cm_s2, 5, 3) );
	...
	ASSERT_EQ( a0_rm.V(rgn(2, 5), rgn(1, 5)),  get_aview2d_rm(a0_rm_s3, 3, 4) );
	ASSERT_EQ( a0_cm.V(rgn(2, 5), rgn(1, 5)),  get_aview2d_cm(a0_cm_s3, 3, 4) );
	...
	ASSERT_TRUE( array_view_equal(a0_rm.V(rgn(2, 5), rgn(1, 6, 2)),  a0_rm_s4, 3, 3) );
	ASSERT_TRUE( array_view_equal(a0_cm.V(rgn(2, 5), rgn(1, 6, 2)),  a0_cm_s4, 3, 3) );
	...
	ASSERT_TRUE( array_view_equal(a0_rm.V(rgn(0, 5, 2), rgn(1, 6, 2)), a0_rm_s5, 3, 3) );
	ASSERT_TRUE( array_view_equal(a0_cm.V(rgn(0, 5, 2), rgn(1, 6, 2)), a0_cm_s5, 3, 3) );
	...
	ASSERT_TRUE( array_view_equal(a0_rm.V(rgn(0, 5, 2), rev_whole()), a0_rm_s6, 3, 6) );
	ASSERT_TRUE( array_view_equal(a0_cm.V(rgn(0, 5, 2), rev_whole()), a0_cm_s6, 3, 6) );
}
...
BCS_TEST_CASE( test_aview2d_copy )
{
	...
	copy(a0_rm, a1_rm);
	ASSERT_TRUE( array_view_equal(a1_rm, a0_buf, m, n) );

	copy(a1_rm, e2_rm);
	ASSERT_TRUE( array_view_equal(e2_rm, a0_buf, m, n) );

	copy(e2_rm, e3_rm);
	ASSERT_TRUE( array_view_equal(e3_rm, a0_buf, m, n) );

	copy(e3_rm, a4_rm);
	ASSERT_TRUE( array_view_equal(a4_rm, a0_buf, m, n) );
	...
	copy(a0_cm, a1_cm);
	ASSERT_TRUE( array_view_equal(a1_cm, a0_buf, m, n) );

	copy(a1_cm, e2_cm);
	ASSERT_TRUE( array_view_equal(e2_cm, a0_buf, m, n) );

	copy(e2_cm, e3_cm);
	ASSERT_TRUE( array_view_equal(e3_cm, a0_buf, m, n) );

	copy(e3_cm, a4_cm);
	ASSERT_TRUE( array_view_equal(a4_cm, a0_buf, m, n) );
}
...
BCS_TEST_CASE( test_aview2d_clone )
{
	...
	ASSERT_TRUE( array_iteration_test(a1_rm) );
	ASSERT_TRUE( a1_rm.pbase() != view1_rm.pbase() );
	ASSERT_EQ( a1_rm, view1_rm );
	...
	ASSERT_TRUE( array_iteration_test(a2_rm) );
	ASSERT_TRUE( array_view_equal(a2_rm, a2_rm_s, 2, 3) );
	...
	ASSERT_TRUE( array_iteration_test(a1_cm) );
	ASSERT_TRUE( a1_cm.pbase() != view1_cm.pbase() );
	ASSERT_EQ( a1_cm, view1_cm );
	...
	ASSERT_TRUE( array_iteration_test(a2_cm) );
	ASSERT_TRUE( array_view_equal(a2_cm, a2_cm_s, 2, 3) );
}
...
BCS_TEST_CASE( test_subarr_selection2d )
{
	...
	ASSERT_TRUE( array_view_equal(s0_rm, s0_rm_r, sn0) );
	ASSERT_TRUE( array_view_equal(s0_cm, s0_cm_r, sn0) );
	...
	ASSERT_TRUE( array_view_equal(s1_rm, s1_rm_r, sn1, n0) );
	ASSERT_TRUE( array_view_equal(s1_cm, s1_cm_r, sn1, n0) );
	...
	ASSERT_TRUE( array_view_equal(s2_rm, s2_rm_r, m0, sn2) );
	ASSERT_TRUE( array_view_equal(s2_cm, s2_cm_r, m0, sn2) );
	...
	ASSERT_TRUE( array_view_equal(s3_rm, s3_rm_r, sm3, sn3) );
	ASSERT_TRUE( array_view_equal(s3_cm, s3_cm_r, sm3, sn3) );
