...
TEST( Array2D, Array2DClone )
{
	...
	aview2d_ex<double, row_major_t, step_ind, step_ind> view2_rm(src, 4, 5, step_ind(2, 2), step_ind(3, 2));
	...
	aview2d_ex<double, column_major_t, step_ind, step_ind> view2_cm(src, 4, 5, step_ind(2, 2), step_ind(3, 2));
...
TEST( Array2D, Slices )
{
	...
	array2d<double, row_major_t> Arm( aview2d_ex<double, row_major_t, id_ind, id_ind>(src, 7, 8, id_ind(5), id_ind(6)) );
	array2d<double, column_major_t> Acm( aview2d_ex<double, column_major_t, id_ind, id_ind>(src, 7, 8, id_ind(5), id_ind(6)) );
...
TEST( Array2D, SubViews )
{
	...
	array2d<double, row_major_t> a0_rm( aview2d_ex<double, row_major_t, id_ind, id_ind>(src0, 7, 8, id_ind(5), id_ind(6)) );
	array2d<double, column_major_t> a0_cm( aview2d_ex<double, column_major_t, id_ind, id_ind>(src0, 7, 8, id_ind(5), id_ind(6)) );
...
TEST( Array2D, ViewCopy )
{
	...
	aview2d_ex<double, row_major_t, step_ind, step_ind> e2_rm(e2_buf, 2*m, 2*n, step_ind(m, 2), step_ind(n, 2));
	aview2d_ex<double, row_major_t, step_ind, step_ind> e3_rm(e3_buf, 2*m, 2*n, step_ind(m, 2), step_ind(n, 2));
	...
	aview2d_ex<double, column_major_t, step_ind, step_ind> e2_cm(e2_buf, 2*m, 2*n, step_ind(m, 2), step_ind(n, 2));
	aview2d_ex<double, column_major_t, step_ind, step_ind> e3_cm(e3_buf, 2*m, 2*n, step_ind(m, 2), step_ind(n, 2));
